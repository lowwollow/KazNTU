...
@Database(entities = {AccountEntity.class, ResponseJournal.class, Schedule.class, Exam.class, Attestation.class, SemestersItem.class, Umkd.class, Language.class, Notification.class, ChosenDiscipline1.class, DeferredDiscipline1.class}, version = 10, exportSchema = false)
