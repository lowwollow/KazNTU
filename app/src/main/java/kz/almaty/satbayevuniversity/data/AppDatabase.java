...
@Database(entities = {AccountEntity.class, ResponseJournal.class, Schedule.class, Exam.class, Attestation.class, SemestersItem.class, Umkd.class, Language.class, Notification.class, Semesters1.class, DeferredDiscipline1.class}, version = 11, exportSchema = false)
