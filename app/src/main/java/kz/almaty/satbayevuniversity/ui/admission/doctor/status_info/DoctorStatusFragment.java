...
public class DoctorStatusFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        DoctorStatusViewModel masterStatusViewModel = ViewModelProviders.of(this).get(DoctorStatusViewModel.class);
    ...
    public static DoctorStatusFragment newInstance(){
        return new DoctorStatusFragment();
    }
}
