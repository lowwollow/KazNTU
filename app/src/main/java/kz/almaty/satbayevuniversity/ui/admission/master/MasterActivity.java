package kz.almaty.satbayevuniversity.ui.admission.master;
...
import kz.almaty.satbayevuniversity.ui.admission.master.choosing_education.MasterChoosingEducationProgrammFragment;
import kz.almaty.satbayevuniversity.ui.admission.master.education_info.MasterEducationInfoFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.choosing_education_programm:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, MasterChoosingEducationProgrammFragment.newInstance()).commit();
                break;
            case R.id.residence:
            ...
            case R.id.info_about_education:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, MasterEducationInfoFragment.newInstance()).commit();
                break;
